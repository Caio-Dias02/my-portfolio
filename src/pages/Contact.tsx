...
export default function Contact() {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: "LinkedIn",
      value: "caio-dias-755494204",
      link: "https://www.linkedin.com/in/caio-dias-755494204/",
    ...
    },
    {
      ...
      title: "GitHub",
      value: "Caio-Dias02",
      link: "https://github.com/Caio-Dias02",
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl border border-gray-200/50 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              ...
              <Button 
                ...
                variant="outline" 
                size="lg"
                className="border-2 border-blue-400 text-blue-600 hover:bg-blue-400 hover:text-white font-semibold px-6 sm:px-8 py-3 rounded-full transition-all duration-300 text-sm sm:text-base btn-animate focus-ring"
              >
