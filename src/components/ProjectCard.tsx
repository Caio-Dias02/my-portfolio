      ...
      <Card className="bg-white/10 backdrop-blur-md border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:bg-white/15 overflow-hidden h-full">
        ...
        <CardContent className="pb-4 flex-1 px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            ...
            {tech.length > 6 && (
              <span className="px-2 sm:px-3 py-1 bg-gray-500/30 text-gray-300 text-xs font-medium rounded-full border border-gray-400/30">
                +{tech.length - 6}
              </span>
            )}
          </div>
        ...
        <CardFooter className="pt-0 flex gap-2 px-4 sm:px-6 pb-4 sm:pb-6">
          {link ? (
            <Button 
              asChild 
